...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-capital_cost-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_capital_cost(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-capital_cost-type-select' in \
                trigger_id['type'] or 'messageix-capital_cost-level-select' in trigger_id['type'] or 'messageix-capital_cost-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-capital_cost-level-select' in trigger_id['type']:
