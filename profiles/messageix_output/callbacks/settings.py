...
def link(app):
    @app.callback(
    Output('messageix-settings-upload-yaml-output', 'children'),
    Input('messageix-settings-upload-yaml', 'contents'),
    State('messageix-settings-upload-yaml', 'filename'),
    )
    def update_settings(content, filename):
        ...
        data_handler.profiles['MESSAGEix-Canada'].settings = settings
        return html.Div([
    ...
    @app.callback(
        Output('messageix-technology-settings-output', 'children'),
        Input('messageix-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('messageix-plot-settings-output', 'children'),
        Input('messageix-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'messageix-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'messageix-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'messageix-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'messageix-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'messageix-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'messageix-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'messageix-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'messageix-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'messageix-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'messageix-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'messageix-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'messageix-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'messageix-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'messageix-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'messageix-plot-update':
                    disabled[idx] = True
