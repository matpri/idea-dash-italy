...
def link(app):
    ...
    def update_cost(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-cost-type-select' in \
                trigger_id['type'] or 'messageix-cost-level-select' in trigger_id['type'] or 'messageix-cost-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-cost-level-select' in trigger_id['type']:
