...
def link(app):
    ...
    def update_primary_energy(_p_type, _aggregates, _scenarios, _scenario, _regions, _years, _variables, _pattern, _text,
        ...
        if 'messageix-primary_energy-download-button' in trigger_id['type']:
            ...
            return _canvas, _r_style, _y_style, _v_style, _v_data, _data, _s_style, _m_style, _pattern_style, _text_style
        idx = 0
        for i, id in enumerate(ctx.inputs_list[0]):
            if ((id['id']['index'] == trigger_id['index']) and
        ...
        if _p_type[idx] == 'By Year':
            ...
            if 'messageix-primary_energy-aggregate-switch' in trigger_id['type']:
                if _aggregates[idx] is not None:
