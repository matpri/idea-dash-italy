...
def link(app):
    ...
    def update_resource(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-resource-type-select' in \
                trigger_id['type'] or 'messageix-resource-level-select' in trigger_id['type'] or 'messageix-resource-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-resource-level-select' in trigger_id['type']:
