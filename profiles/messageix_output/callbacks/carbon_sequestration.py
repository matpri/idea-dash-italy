...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-carbon_sequestration-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_carbon_sequestration(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-carbon_sequestration-type-select' in \
                trigger_id['type'] or 'messageix-carbon_sequestration-level-select' in trigger_id['type'] or 'messageix-carbon_sequestration-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-carbon_sequestration-level-select' in trigger_id['type']:
