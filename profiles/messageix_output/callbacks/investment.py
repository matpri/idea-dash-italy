...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-investment-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_investment(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-investment-type-select' in \
                trigger_id['type'] or 'messageix-investment-level-select' in trigger_id['type'] or 'messageix-investment-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-investment-level-select' in trigger_id['type']:
