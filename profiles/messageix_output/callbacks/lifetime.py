...
def link(app):
    ...
    def update_lifetime(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-lifetime-type-select' in \
                trigger_id['type'] or 'messageix-lifetime-level-select' in trigger_id['type'] or 'messageix-lifetime-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-lifetime-level-select' in trigger_id['type']:
