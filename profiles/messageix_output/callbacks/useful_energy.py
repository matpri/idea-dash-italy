...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-useful_energy-variable-select',
            'index': ALL
        }, 'style'),
        Output({
            'type': 'messageix-useful_energy-variable-select',
    ...
    def update_useful_energy(_p_type, _aggregates, _scenarios, _scenario, _regions, _years, _variables, _pattern, _text,
        ...
        if _p_type[idx] == 'By Year':
            ...
            if 'messageix-useful_energy-aggregate-switch' in trigger_id['type']:
                if _aggregates[idx] is not None:
