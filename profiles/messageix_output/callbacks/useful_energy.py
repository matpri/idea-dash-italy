...
def link(app):
    ...
    def update_useful_energy(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-useful_energy-type-select' in \
                trigger_id['type'] or 'messageix-useful_energy-level-select' in trigger_id['type'] or 'messageix-useful_energy-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-useful_energy-level-select' in trigger_id['type']:
