...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-capacity_additions-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_capacity_additions(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-capacity_additions-type-select' in \
                trigger_id['type'] or 'messageix-capacity_additions-level-select' in trigger_id['type'] or 'messageix-capacity_additions-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-capacity_additions-level-select' in trigger_id['type']:
