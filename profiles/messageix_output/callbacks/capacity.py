...
def link(app):
    ...
    def update_capacity(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-capacity-type-select' in \
                trigger_id['type'] or 'messageix-capacity-multi-level-select' in trigger_id['type'] or 'messageix-capacity-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-capacity-multi-level-select' in trigger_id['type']:
