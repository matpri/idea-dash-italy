...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-cumulative_capacity-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_cumulative_capacity(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-cumulative_capacity-type-select' in \
                trigger_id['type'] or 'messageix-cumulative_capacity-level-select' in trigger_id['type'] or 'messageix-cumulative_capacity-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-cumulative_capacity-level-select' in trigger_id['type']:
