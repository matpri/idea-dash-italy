...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-secondary_energy-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_secondary_energy(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-secondary_energy-type-select' in \
                trigger_id['type'] or 'messageix-secondary_energy-level-select' in trigger_id['type'] or 'messageix-secondary_energy-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-secondary_energy-level-select' in trigger_id['type']:
