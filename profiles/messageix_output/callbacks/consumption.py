...
def link(app):
    ...
    def update_consumption(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-consumption-type-select' in \
                trigger_id['type'] or 'messageix-consumption-level-select' in trigger_id['type'] or 'messageix-consumption-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-consumption-level-select' in trigger_id['type']:
