...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'messageix-primary_energy_sub-multi-level-select',
            'index': MATCH,
            'level': ALL
        }, 'style'),
        Output({
    ...
    def update_primary_energy_sub(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-primary_energy_sub-type-select' in \
                trigger_id['type'] or 'messageix-primary_energy_sub-multi-level-select' in trigger_id['type'] or 'messageix-primary_energy_sub-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-primary_energy_sub-multi-level-select' in trigger_id['type']:
