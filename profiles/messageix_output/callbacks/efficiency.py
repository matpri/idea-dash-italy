...
def link(app):
    ...
    def update_efficiency(_p_type, _show_sectors, _scenarios, _scenario, _regions, _years, _types, _levels, _pattern,
        ...
        if 'messageix-efficiency-type-select' in \
                trigger_id['type'] or 'messageix-efficiency-multi-level-select' in trigger_id['type'] or 'messageix-efficiency-show_sector-switch' in trigger_id['type']:
        ...
        if 'messageix-efficiency-multi-level-select' in trigger_id['type']:
