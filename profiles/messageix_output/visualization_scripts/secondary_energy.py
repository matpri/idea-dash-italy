...
def render_plot(type, df, aggregate, scenarios, region, year, scenario, pattern_active=True, text_active=False,
    ...
    if type == 'By Year':
        ...
        plot_info = plot_settings['Secondary Energy']['Trend Over Years']
        ...
        plot_info = plot_settings['Secondary Energy']['Pie Chart']
...
def plot(df, window_id):
    ...
    parents = ['Secondary Energy|' + parent for parent in parents]
    ...
    widget_layout = html.Div([
        ...
        *map_plot_widgets,
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'messageix-secondary_energy-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'messageix-secondary_energy-download', 'index': window_id}),
    ])
