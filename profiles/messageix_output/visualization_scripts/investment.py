...
def render_plot(type, df, aggregate, scenarios, region, year, scenario, pattern_active=True, text_active=False,
    ...
    name = plot_settings['Investment']['name']
    unit = plot_settings['Investment']['unit']

    if type == 'By Year':
        plot_info = plot_settings['Investment']['By Year']
        ...
        plot_info = plot_settings['Investment']['Trend Over Years']
        ...
        plot_info = plot_settings['Investment']['Pie Chart']
        ...
        title = plot_settings['Investment']['Map']['title']
        return map_plot.plot_map(df, scenario, year, title, name, unit, variables)
    else:
        plot_info = plot_settings['Investment']['By Region']
...
def plot(df, window_id):
    ...
    parents = ['Investment|' + parent for parent in parents]
    ...
    widget_layout = html.Div([
        ...
        *map_plot_widgets,
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'messageix-investment-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'messageix-investment-download', 'index': window_id}),
    ])
