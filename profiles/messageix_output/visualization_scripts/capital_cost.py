...
def render_plot(type, df, aggregate, scenarios, region, year, scenario, pattern_active=True, text_active=False,
    ...
    name = plot_settings['Capital Cost']['name']
    unit = plot_settings['Capital Cost']['unit']

    if type == 'By Year':
        plot_info = plot_settings['Capital Cost']['By Year']
        ...
        plot_info = plot_settings['Capital Cost']['Trend Over Years']
        ...
        plot_info = plot_settings['Capital Cost']['Pie Chart']
        ...
        title = plot_settings['Capital Cost']['Map']['title']
        return map_plot.plot_map(df, scenario, year, title, name, unit, variables)
    else:
        plot_info = plot_settings['Capital Cost']['By Region']
...
def plot(df, window_id):
    ...
    parents = ['Capital Cost|' + parent for parent in parents]
    ...
    widget_layout = html.Div([
        ...
        *map_plot_widgets,
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'messageix-capital_cost-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'messageix-capital_cost-download', 'index': window_id}),
    ])
