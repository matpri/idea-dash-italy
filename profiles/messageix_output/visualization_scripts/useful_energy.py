...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        *map_plot_widgets,
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'messageix-useful_energy-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'messageix-useful_energy-download', 'index': window_id}),
    ])
