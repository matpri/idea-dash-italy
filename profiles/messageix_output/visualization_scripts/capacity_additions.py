...
def render_plot(type, df, aggregate, scenarios, region, year, scenario, pattern_active=True, text_active=False,
    ...
    name = plot_settings['Capacity Additions']['name']
    unit = plot_settings['Capacity Additions']['unit']

    if type == 'By Year':
        plot_info = plot_settings['Capacity Additions']['By Year']
        ...
        plot_info = plot_settings['Capacity Additions']['Trend Over Years']
        ...
        plot_info = plot_settings['Capacity Additions']['By Region']
...
def plot(df, window_id):
    ...
    parents = ['Capacity Additions|' + parent for parent in parents]
    ...
    widget_layout = html.Div([
        ...
        *map_plot_widgets,
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'messageix-capacity_additions-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'messageix-capacity_additions-download', 'index': window_id}),
    ])
