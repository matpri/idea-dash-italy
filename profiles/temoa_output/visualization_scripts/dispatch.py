...
from profiles.temoa_output.utils import custom_sort_key
...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        dmc.Button('Download Data', id={'type': 'temoa-dispatch-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'temoa-dispatch-download', 'index': window_id}),
    ])
