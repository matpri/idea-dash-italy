...
def link(app):
    @app.callback(
    Output('temoa-settings-upload-yaml-output', 'children'),
    Input('temoa-settings-upload-yaml', 'contents'),
    State('temoa-settings-upload-yaml', 'filename'),
    )
    def update_settings(content, filename):
        ...
        data_handler.profiles['Sutubra-TEMOA Output'].settings = settings
        return html.Div([
    ...
    @app.callback(
        Output('temoa-technology-settings-output', 'children'),
        Input('temoa-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('temoa-plot-settings-output', 'children'),
        Input('temoa-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'temoa-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'temoa-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'temoa-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'temoa-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'temoa-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'temoa-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'temoa-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'temoa-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'temoa-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'temoa-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'temoa-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'temoa-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'temoa-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'temoa-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'temoa-plot-update':
                    disabled[idx] = True
