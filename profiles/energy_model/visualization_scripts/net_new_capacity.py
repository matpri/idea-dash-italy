...
def plot(df, window_id):
    ...
    by_region_widgets = dmc.Select(
        ...
        value=years[0],
        id={
            'type': 'energy_model-netnew_capacity-year-select',
            'index': window_id
        },
    ...
    text_toggle = dmc.Switch(
        ...
        checked=False,
        id={
            'type': 'energy_model-netnew_capacity-text-switch',
            'index': window_id,
        },
        style={'display': 'block'}
    )
    ...
    widget_layout = html.Div([
        ...
        dmc.Switch('Aggregate',
                   checked=True,
                   id={
                       'type': 'energy_model-netnew_capacity-aggregate-switch',
                       'index': window_id}),
        pattern_toggle,
        text_toggle,
        dmc.MultiSelect(
            ...
            value=[scenarios[0]],
            id={
                'type': 'energy_model-netnew_capacity-scenario-multi-select',
                'index': window_id,
            },
            style={'display': 'block'}
        ),
        ...
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'energy_model-netnew_capacity-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                     style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'energy_model-netnew_capacity-download', 'index': window_id}),
    ])
