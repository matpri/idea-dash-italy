...
def render_plot(type, df, aggregate, scenarios, region, year, scenario, pattern_active=True, text_active=False, report_type='Total'):
    ...
    if type == 'By Year':
        plot_info = plot_settings['New Capacity']['By Year']
        ...
        plot_info = plot_settings['New Capacity']['Trend Over Years']
        ...
        plot_info = plot_settings['New Capacity']['Pie Chart']
        return pie_chart.plot(df, scenario, region, year, aggregate, plot_info['title'], plot_info['x_label'],
                              plot_info['y_label'])
    else:
        plot_info = plot_settings['New Capacity']['By Region']
...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        by_year_widgets,
        by_region_widgets,
        dmc.Button('Download Data', id={'type': 'energy_model-new_capacity-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'energy_model-new_capacity-download', 'index': window_id}),
    ])
