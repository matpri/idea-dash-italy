...
def link(app):
    ...
    def update_gencap(_p_type, _aggregates, _scenarios, _scenario_group, _scenario, _regions, _report_type, _years, _pattern, _text,
        ...
        if _p_type[idx] == 'By Year':
            ...
            df = data_handler.processed_data['Power System Models']['Capacity']
