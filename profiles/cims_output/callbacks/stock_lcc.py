...
def link(app):
    ...
    def update_stock_lcc(_p_type, _scenarios, _scenario, _variable, _regions, _years, _pattern, _text,
        ...
        if 'cims-stock_lcc-download-button' in trigger_id['type']:
            _data = dcc.send_data_frame(data_handler.processed_data['CIMS Output']['Stock LCC'].to_csv,
                                        "stock_lcc.csv")
        ...
        if 'cims-stock_lcc-sector-select' in trigger_id['type']:
            _data = data_handler.processed_data['CIMS Output']['Stock LCC']
        ...
        if _p_type == 'By Year':
            ...
            _canvas = render_plot('By Year',
                                  data_handler.processed_data['CIMS Output']['Stock LCC'],
                                  _scenarios,
                                  _regions,
