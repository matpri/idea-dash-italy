...
from profiles.cims_output.visualization_scripts.waste import render_plot
...
def link(app):
    @app.callback(
        ...
        Input({
            'type': 'cims-waste-download-button',
            'index': MATCH
        }, 'n_clicks'),
    ...
    def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
        ...
        _data = data_handler.processed_data['CIMS Output']['Waste']

        if trigger_id['type'] == 'cims-waste-download-button':
            return (dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dcc.send_data_frame(_data.to_csv, "waste.csv"))
