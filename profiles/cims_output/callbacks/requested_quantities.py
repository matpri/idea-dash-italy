...
def link(app):
    ...
    def update_requested_quantities(_update, _representation, _p_type, _scenarios, _scenario, _regions, _years, _pattern, _text,
        ...
        if _p_type == 'By Year':
            ...
            _canvas = render_plot(_representation,'Trend Over Years', _data,
                                       _scenarios,
                                       _regions,
            ...
            _pattern_style = {'display': 'none'}
            _text_style = {'display': 'none'}
            _canvas = render_plot(_representation,'Sankey', _data,
                                       _scenarios,
                                       _regions,
                                       _years, scenario=_scenario, sector=_sector, service=_service, fuel=_fuel)
