...
from profiles.cims_output.visualization_scripts.residential import render_plot
...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'cims-residential-download',
            'index': MATCH
        }, 'data'),
        Input({
        ...
        Input({
            'type': 'cims-residential-download-button',
            'index': MATCH
        }, 'n_clicks'),
    ...
    def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
        ...
        _data = data_handler.processed_data['CIMS Output']['Residential']

        if trigger_id['type'] == 'cims-residential-download-button':
            return (dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dcc.send_data_frame(_data.to_csv, "residential.csv"))
        ...
        if trigger_id['type'] == 'cims-residential-plot-select':
