...
from profiles.cims_output.visualization_scripts.electricity import render_plot
...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'cims-electricity-download',
            'index': MATCH
        }, 'data'),
        Input({
        ...
        Input({
            'type': 'cims-electricity-download-button',
            'index': MATCH
        }, 'n_clicks'),
    ...
    def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
        ...
        if trigger_id['type'] == 'cims-electricity-download-button':
            return (dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    ...
                    dcc.send_data_frame(_data.to_csv, "electricity.csv"))
        ...
        if trigger_id['type'] == 'cims-electricity-plot-select':
