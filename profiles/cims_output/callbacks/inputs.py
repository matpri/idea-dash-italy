...
def link(app):
    ...
    def update_inputs(_p_type, _season, _vre_variable, t_ptype, t_year, t_scenario, t_scenarios,
        ...
        _canvas[idx] = render_plot(_p_type[idx], data_handler.processed_data['CIMS']['Inputs'],
                                   ...
                                   _c_type=_c_select[idx], _c_scenario=_c_scenario[idx], _c_region=_c_region[idx], _c_sector=_c_sector[idx],
                                   _t_cost_scenarios=_t_c_scenarios[idx], _p_scenario=_param_scenario[idx],
                                   _p_variable=_param_variable[idx], _policy_scenarios=_policy_scenarios[idx], _policy_region=_policy_region[idx])
