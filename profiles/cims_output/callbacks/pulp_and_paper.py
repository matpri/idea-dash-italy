...
from profiles.cims_output.visualization_scripts.pulp_and_paper import render_plot
...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'cims-pulp_and_paper-download',
            'index': MATCH
        }, 'data'),
        Input({
        ...
        Input({
            'type': 'cims-pulp_and_paper-download-button',
            'index': MATCH
        }, 'n_clicks'),
    ...
    def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
        ...
        _data = data_handler.processed_data['CIMS Output']['Pulp and Paper']

        if trigger_id['type'] == 'cims-pulp_and_paper-download-button':
            return (dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dcc.send_data_frame(_data.to_csv, "pulp_and_paper.csv"))
        ...
        if trigger_id['type'] == 'cims-pulp_and_paper-plot-select':
