...
from profiles.cims_output.visualization_scripts.petroleum_refining import render_plot
...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'cims-petroleum_refining-download',
            'index': MATCH
        }, 'data'),
        Input({
        ...
        Input({
            'type': 'cims-petroleum_refining-download-button',
            'index': MATCH
        }, 'n_clicks'),
    ...
    def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
        ...
        _data = data_handler.processed_data['CIMS Output']['Petroleum Refining']

        if trigger_id['type'] == 'cims-petroleum_refining-download-button':
            return (dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dcc.send_data_frame(_data.to_csv, "petroleum_refining.csv"))
        ...
        if trigger_id['type'] == 'cims-petroleum_refining-plot-select':
