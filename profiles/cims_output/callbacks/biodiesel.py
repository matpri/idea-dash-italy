...
from profiles.cims_output.visualization_scripts.biodiesel import render_plot
...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'cims-biodiesel-region-select',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-year-select',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-variable-select',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-rep_switch',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-scenario-multi-select',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-scenario-select',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-rep_switch',
        ...
        Output({
            'type': 'cims-biodiesel-pattern-switch',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-text-switch',
            'index': MATCH
        }, 'style'),
        Output({
            'type': 'cims-biodiesel-variable-select',
        ...
        Output({
            'type': 'cims-biodiesel-download',
            'index': MATCH
        }, 'data'),
        Input({
            'type': 'cims-biodiesel-plot-select',
            'index': MATCH
        }, 'value'),
        Input({
            'type': 'cims-biodiesel-rep-select',
            'index': MATCH
        }, 'value'),
        Input({
            'type': 'cims-biodiesel-region-select',
        ...
        Input({
            'type': 'cims-biodiesel-download-button',
            'index': MATCH
        }, 'n_clicks'),
    ...
    def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
        ...
        _data = data_handler.processed_data['CIMS Output']['Biodiesel']

        if trigger_id['type'] == 'cims-biodiesel-download-button':
            return (dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dash.no_update, dash.no_update, dash.no_update, dash.no_update, dash.no_update,
                    dcc.send_data_frame(_data.to_csv, "biodiesel.csv"))
