...
def link(app):
    @app.callback(
    Output('coders_input-settings-upload-yaml-output', 'children'),
    Input('coders_input-settings-upload-yaml', 'contents'),
    State('coders_input-settings-upload-yaml', 'filename'),
    )
    ...
    @app.callback(
        Output('coders_input-technology-settings-output', 'children'),
        Input('coders_input-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('coders_input-plot-settings-output', 'children'),
        Input('coders_input-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'coders_input-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'coders_input-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'coders_input-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'coders_input-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'coders_input-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'coders_input-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'coders_input-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'coders_input-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'coders_input-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'coders_input-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'coders_input-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'coders_input-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'coders_input-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'coders_input-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'coders_input-plot-update':
                    disabled[idx] = True
