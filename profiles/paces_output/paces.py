...
from profiles.paces_output.callbacks import (emissions as emissions_callbacks,
...
from profiles.paces_output.processing_scripts import (
...
from profiles.paces_output.visualization_scripts import (
...
class PyPsaOutput(BaseProfile):
    ...
    color = 'yellow 8'
    description = (
        'The Canadian Opportunities for Planning and Production of Electricity Resources (PaCES) framework is an electricity system planning model. \n'
    ...
    def __init__(self):
        super().__init__()
        self.technologies = yaml.load(open('./profiles/paces_output/technologies.yaml', 'r'), Loader=yaml.FullLoader)
        self.plots = yaml.load(open('./profiles/paces_output/plots.yaml', 'r'), Loader=yaml.FullLoader)
        self.update_utils()
    ...
    def render_settings(self):
        layout = html.Div(
            [
                ...
                html.Div(id='paces-settings-upload-yaml-output'),
                dmc.Tabs([
                    dmc.TabsList([
                        dmc.Tab('Technology Settings', id='paces-technologies', value='tech'),
                        dmc.Tab('Plot Settings', id='paces-plot-settings', value='plot'),
                    ]
                    ),
                    dmc.TabsPanel(id='paces-technologies-settings', value='tech',
                                  children=self.render_technology_settings()),
                    dmc.TabsPanel(id='paces-plot-settings-panel', value='plot',
    ...
    def render_technology_settings(self):
        ...
        layout = html.Div([
            ...
            html.Div(utils.tech_edit(techs[0]),
                     id='paces-technology-settings-output'),
        ])
