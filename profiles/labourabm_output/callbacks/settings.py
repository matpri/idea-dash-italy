...
def link(app):
    @app.callback(
    Output('labourabm-settings-upload-yaml-output', 'children'),
    Input('labourabm-settings-upload-yaml', 'contents'),
    State('labourabm-settings-upload-yaml', 'filename'),
    )
    def update_settings(content, filename):
        ...
        data_handler.profiles['COPPER Output'].settings = settings
        return html.Div([
    ...
    @app.callback(
        Output('labourabm-technology-settings-output', 'children'),
        Input('labourabm-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('labourabm-plot-settings-output', 'children'),
        Input('labourabm-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'labourabm-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'labourabm-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'labourabm-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'labourabm-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'labourabm-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'labourabm-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'labourabm-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'labourabm-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'labourabm-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'labourabm-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'labourabm-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'labourabm-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'labourabm-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'labourabm-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'labourabm-plot-update':
                    disabled[idx] = True
