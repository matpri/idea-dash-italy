...
def link(app):
    ...
    def update_total_demand(_scenarios, _occupations, _download, _canvas, _data):
        ...
        _canvas[idx] = render_plot(data_handler.processed_data['LabourABM Output']['Total Demand'], _scenarios[idx], _occupations[idx])
