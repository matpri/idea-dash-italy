...
def link(app):
    ...
    def update_opf_line_flow(_p_type, _scenarios, _scenario, _ts, _download, _canvas, _data, _s_style, _m_style):
        ...
        if 'silver-opf_line_flow-download-button' in trigger_id['type']:
            ...
            for i, id in enumerate(ctx.inputs_list[0]):
                if ((id['id']['index'] == trigger_id['index']) and
                    ...
                    idx = i
                    break
            _data[idx] = dcc.send_data_frame(data_handler.processed_data['SILVER']['OPF Line Flow'].to_csv,
                                             "opf_line_flow.csv")
        ...
        if _p_type[idx] == 'Total':
            ...
            _canvas[idx] = render_plot('Total', data_handler.processed_data['SILVER']['OPF Line Flow'],
            ...
            _canvas[idx] = render_plot('By Line',
                                       data_handler.processed_data['SILVER']['OPF Line Flow'],
