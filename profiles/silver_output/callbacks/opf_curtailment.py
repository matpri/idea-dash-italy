...
def link(app):
    ...
    def update_opf_vre_curtailment(_p_type, _scenarios, _scenario, _ts, _download, _canvas, _data, _s_style, _m_style):
        ...
        if 'silver-opf_vre_curtailment-download-button' in trigger_id['type']:
            ...
            for i, id in enumerate(ctx.inputs_list[0]):
                if ((id['id']['index'] == trigger_id['index']) and
                    ...
                    idx = i
                    break
            _data[idx] = dcc.send_data_frame(data_handler.processed_data['SILVER']['OPF_VRE_Curtailment'].to_csv,
                                             "opf_vre_curtailment.csv")
        ...
        if _p_type[idx] == 'Total':
            ...
            _canvas[idx] = render_plot('Total', data_handler.processed_data['SILVER']['OPF_VRE_Curtailment'],
            ...
            _canvas[idx] = render_plot('By Plant',
                                       data_handler.processed_data['SILVER']['OPF_VRE_Curtailment'],
