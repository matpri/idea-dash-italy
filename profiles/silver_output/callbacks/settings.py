...
def link(app):
    @app.callback(
    Output('silver-settings-upload-yaml-output', 'children'),
    Input('silver-settings-upload-yaml', 'contents'),
    State('silver-settings-upload-yaml', 'filename'),
    )
    ...
    @app.callback(
        Output('silver-technology-settings-output', 'children'),
        Input('silver-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('silver-plot-settings-output', 'children'),
        Input('silver-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'silver-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'silver-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'silver-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'silver-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'silver-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'silver-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'silver-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'silver-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'silver-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'silver-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'silver-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'silver-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'silver-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'silver-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'silver-plot-update':
                    disabled[idx] = True
