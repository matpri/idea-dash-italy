...
def link(app):
    @app.callback(
    Output('cef-settings-upload-yaml-output', 'children'),
    Input('cef-settings-upload-yaml', 'contents'),
    State('cef-settings-upload-yaml', 'filename'),
    )
    def update_settings(content, filename):
        ...
        data_handler.profiles['Canada Energy Futures'].settings = settings
        return html.Div([
    ...
    @app.callback(
        Output('cef-technology-settings-output', 'children'),
        Input('cef-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('cef-plot-settings-output', 'children'),
        Input('cef-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'cef-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'cef-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'cef-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'cef-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'cef-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'cef-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'cef-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'cef-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'cef-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'cef-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'cef-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'cef-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'cef-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'cef-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'cef-plot-update':
                    disabled[idx] = True
