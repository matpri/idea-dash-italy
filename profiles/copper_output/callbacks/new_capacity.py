...
def link(app):
    ...
    def update_newcapacity(_p_type, _aggregates, _scenarios, _regions, _years, _r_style, _y_style, _canvas):
        print('updating newcapacity plot')
        ...
        for i, id in enumerate(ctx.inputs_list[0]):
            if ((id['id']['index'] == trigger_id['index']) and
                    (id['id']['type'] == 'copper-newcapacity-plot-select')):
                idx = i
                break
