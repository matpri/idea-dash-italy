...
def link(app):
    @app.callback(
    Output('copper-settings-upload-yaml-output', 'children'),
    Input('copper-settings-upload-yaml', 'contents'),
    State('copper-settings-upload-yaml', 'filename'),
    )
    ...
    @app.callback(
        Output('copper-technology-settings-output', 'children'),
        Input('copper-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('copper-plot-settings-output', 'children'),
        Input('copper-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'copper-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'copper-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'copper-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'copper-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'copper-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'copper-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'copper-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'copper-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'copper-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'copper-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'copper-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'copper-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'copper-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'copper-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'copper-plot-update':
                    disabled[idx] = True
