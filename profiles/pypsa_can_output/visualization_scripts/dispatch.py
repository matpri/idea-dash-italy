...
from profiles.pypsa_can_output.utils import custom_sort_key
...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        dmc.Button('Download Data', id={'type': 'pypsa_can-dispatch-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'pypsa_can-dispatch-download', 'index': window_id}),
    ])
