...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        dmc.Select(
            ...
            id={
                'type': 'pypsa_can-transmissioncapacity-scenario-group-select',
                'index': window_id,
            },
            style={'display': 'none'}
        ),
        ...
        dmc.Select(
            ...
            value=lines[0],
            id={
                'type': 'pypsa_can-transmissioncapacity-lines-select',
                'index': window_id
            },
            style={'display': 'none'}
        ),

        dmc.Button('Download Data', id={'type': 'pypsa_can-transmissioncapacity-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                     style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'pypsa_can-transmissioncapacity-download', 'index': window_id}),
