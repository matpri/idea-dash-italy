...
from profiles.pypsa_can_output.visualization_scripts.utils import bar_over_regions, bar_over_years, trend_over_years
...
def transmission_plot(df, scenario, year, title):
    ...
    with open('./profiles/pypsa_can_output/visualization_scripts/utils/canada.geojson') as f:
        canada = geojson.load(f)
    with open('./profiles/pypsa_can_output/visualization_scripts/utils/arrows.geojson') as f:
...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        dmc.Button('Download Data', id={'type': 'pypsa_can-transmissionflow-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                     style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'pypsa_can-transmissionflow-download', 'index': window_id}),
