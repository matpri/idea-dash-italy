...
def link(app):
    @app.callback(
    Output('macromodel-settings-upload-yaml-output', 'children'),
    Input('macromodel-settings-upload-yaml', 'contents'),
    State('macromodel-settings-upload-yaml', 'filename'),
    )
    def update_settings(content, filename):
        ...
        data_handler.profiles['COPPER'].settings = settings
        return html.Div([
    ...
    @app.callback(
        Output('macromodel-technology-settings-output', 'children'),
        Input('macromodel-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('macromodel-plot-settings-output', 'children'),
        Input('macromodel-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'macromodel-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'macromodel-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'macromodel-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'macromodel-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'macromodel-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'macromodel-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'macromodel-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'macromodel-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'macromodel-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'macromodel-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'macromodel-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'macromodel-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'macromodel-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'macromodel-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'macromodel-plot-update':
                    disabled[idx] = True
