...
def link(app):
    @app.callback(
    Output('obps-settings-upload-yaml-output', 'children'),
    Input('obps-settings-upload-yaml', 'contents'),
    State('obps-settings-upload-yaml', 'filename'),
    )
    ...
    @app.callback(
        Output('obps-technology-settings-output', 'children'),
        Input('obps-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('obps-plot-settings-output', 'children'),
        Input('obps-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'obps-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'obps-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'obps-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'obps-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'obps-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'obps-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'obps-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'obps-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'obps-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'obps-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'obps-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'obps-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'obps-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'obps-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'obps-plot-update':
                    disabled[idx] = True
