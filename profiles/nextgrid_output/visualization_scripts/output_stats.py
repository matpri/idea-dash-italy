...
def plot(df, window_id):
    ...
    widget_layout = html.Div([
        ...
        dmc.Button('Download Data', id={'type': 'nextgrid_output-output_stats-download-button', 'index': window_id},
                   variant='light',
                   # center the button
                   style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
        dcc.Download(id={'type': 'nextgrid_output-output_stats-download', 'index': window_id}),
    ])
