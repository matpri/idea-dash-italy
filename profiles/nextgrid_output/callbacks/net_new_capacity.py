...
def link(app):
    @app.callback(
        ...
        Output({
            'type': 'nextgrid-netnew_capacity-download',
            'index': ALL
        }, 'data'),
        Output({
        ...
        Input({
            'type': 'nextgrid-netnew_capacity-download-button',
            'index': ALL
        }, 'n_clicks'),
        State({
            'type': 'nextgrid-netnew_capacity-region-select',
    ...
    def update_netnew_capacity(_p_type, _aggregates, _scenarios, _scenario, _regions, _years, _pattern, _text,
        ...
        if 'nextgrid-netnew_capacity-download-button' in trigger_id['type']:
            idx = 0
        ...
        for i, id in enumerate(ctx.inputs_list[0]):
            if ((id['id']['index'] == trigger_id['index']) and
                    (id['id']['type'] == 'nextgrid-netnew_capacity-plot-select')):
                idx = i
                break
