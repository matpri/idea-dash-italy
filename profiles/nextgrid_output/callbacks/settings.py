...
def link(app):
    @app.callback(
    Output('nextgrid-settings-upload-yaml-output', 'children'),
    Input('nextgrid-settings-upload-yaml', 'contents'),
    State('nextgrid-settings-upload-yaml', 'filename'),
    )
    ...
    @app.callback(
        Output('nextgrid-technology-settings-output', 'children'),
        Input('nextgrid-technology-select', 'value')
    )
    ...
    @app.callback(
        Output('nextgrid-plot-settings-output', 'children'),
        Input('nextgrid-plot-select', 'value')
    )
    ...
    @app.callback(
        Output({'type': 'nextgrid-tech-update', 'index': ALL}, 'disabled'),
        Input({'type': 'nextgrid-tech-update', 'index': ALL}, 'n_clicks'),
        Input({'type': 'nextgrid-tech-name', 'index': ALL}, 'value'),
        Input({'type': 'nextgrid-tech-group', 'index': ALL}, 'value'),
        Input({'type': 'nextgrid-tech-color', 'index': ALL}, 'value'),
        Input({'type': 'nextgrid-tech-group-color', 'index': ALL}, 'value'),
        State({'type': 'nextgrid-tech-update', 'index': ALL}, 'disabled'),
    ...
    def tech_update(n_clicks, names, groups, colors, group_colors, disabled):
        ...
        if trigger_id['type'] == 'nextgrid-tech-update':
            disabled[idx] = True
    ...
    @app.callback(
        Output({'type': 'nextgrid-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        Input({'type': 'nextgrid-plot-update', 'index': ALL, 'subtype':ALL}, 'n_clicks'),
        Input({'type': 'nextgrid-plot-title', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'nextgrid-plot-x-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        Input({'type': 'nextgrid-plot-y-axis', 'index': ALL, 'subtype':ALL}, 'value'),
        State({'type': 'nextgrid-plot-update', 'index': ALL, 'subtype':ALL}, 'disabled'),
        prevent_initial_call=True
    )
    def plot_update(n_clicks, titles, x_axis, y_axis, disabled):
        ...
        for i, out in enumerate(ctx.outputs_list):
            if out['id']['index'] == trigger_id['index']:
                if trigger_id['type'] == 'nextgrid-plot-update':
                    disabled[idx] = True
