...
from profiles.nextgrid_output.processing_scripts import (
...
from profiles.nextgrid_output.visualization_scripts import (
...
class NextGridOutput(BaseProfile):
    ...
    def __init__(self):
        super().__init__()
        self.technologies = yaml.load(open('./profiles/nextgrid_output/technologies.yaml', 'r'), Loader=yaml.FullLoader)
        self.plots = yaml.load(open('./profiles/nextgrid_output/plots.yaml', 'r'), Loader=yaml.FullLoader)
        self.update_utils()
    ...
    def render_settings(self):
        layout = html.Div(
            [
                # upload for yaml
                dcc.Upload(
                    id='nextgrid-settings-upload-yaml',
                    children=html.Div([
                        'Drag and Drop or ',
                ...
                html.Div(id='nextgrid-settings-upload-yaml-output'),
                dmc.Tabs([
                    dmc.TabsList([
                        dmc.Tab('Technology Settings', id='nextgrid-technologies', value='tech'),
                        dmc.Tab('Plot Settings', id='nextgrid-plot-settings', value='plot'),
                    ]
                    ),
                    dmc.TabsPanel(id='nextgrid-technologies-settings', value='tech',
                                  children=self.render_technology_settings()),
                    dmc.TabsPanel(id='nextgrid-plot-settings-panel', value='plot',
    ...
    def render_technology_settings(self):
        ...
        layout = html.Div([
            ...
            html.Div(utils.tech_edit(techs[0]),
                     id='nextgrid-technology-settings-output'),
        ])
    ...
    def render_plot_settings(self):
        ...
        layout = html.Div([
            ...
            html.Div(utils.plot_edit(plots[0]),
                     id='nextgrid-plot-settings-output'),
        ])
