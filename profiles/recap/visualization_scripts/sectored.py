    ...
    def plot(df, window_id):
        ...
        widget_layout = html.Div([
            ...
            *by_service_widgets,
            by_year_widgets,
            by_region_widgets,
            dmc.Button('Download Data', id={'type': f'recap-{lower_sector}-download-button', 'index': window_id},
                       variant='light',
                       style={'display': 'flex', 'justify-content': 'center', 'margin-top': '4px'}),
            dcc.Download(id={'type': f'recap-{lower_sector}-download', 'index': window_id}),
        ])
