...
from profiles.recap.visualization_scripts.sectored import render_plot
...
def create_link(sector):
    ...
    def link(app):
        @app.callback(
            ...
            Output({
                'type': f'recap-{lower_sector}-region-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-year-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-variable-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-rep_switch',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-scenario-multi-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-scenario-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-rep_switch',
            ...
            Output({
                'type': f'recap-{lower_sector}-pattern-switch',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-text-switch',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-variable-select',
            ...
            Output({
                'type': f'recap-{lower_sector}-download',
                'index': MATCH
            }, 'data'),
            Output({
                'type': f'recap-{lower_sector}-service-select',
                'index': MATCH,
                'layer': ALL
            }, 'data'),
            Output({
            ...
            Output({
                'type': f'recap-{lower_sector}-energy-rep-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-emissions-rep-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-tech-service-select',
                'index': MATCH
            }, 'style'),
            Output({
                'type': f'recap-{lower_sector}-tech-service-select',
            ...
            Input({
                'type': f'recap-{lower_sector}-plot-select',
                'index': MATCH
            }, 'value'),
            Input({
                'type': f'recap-{lower_sector}-rep-select',
            ...
            Input({
                'type': f'recap-{lower_sector}-download-button',
                'index': MATCH
            }, 'n_clicks'),
            Input({
                'type': f'recap-{lower_sector}-service-select',
        ...
        def update_plot(plot_type, plot, region, year, variable, scenarios, scenario, rep_switch, pattern_switch,
            ...
            if trigger_id['type'] == f'recap-{lower_sector}-download-button':
            ...
            if f'recap-{lower_sector}-service-select' in trigger_id['type']:
            ...
            if trigger_id['type'] == f'recap-{lower_sector}-plot-select' or trigger_id['type'] == f'recap-{lower_sector}-energy-rep-select' or trigger_id['type'] == f'recap-{lower_sector}-emissions-rep-select':
            ...
            if trigger_id['type'] == f'recap-{lower_sector}-plot-select':
