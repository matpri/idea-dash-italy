...
# # from profiles.recap.callbacks import ghg, stock_lcc, requested_quantities
...
# from profiles.recap.callbacks import requested_quantities
# from components import ids

# def link(app):
#     """
#     Link callbacks for the Energy Demand-only overview visualization.
#     No tab switching needed - only energy demand functionality.
#     """
#     # Link the requested_quantities callbacks for energy demand functionality
#     requested_quantities.link(app)
    
#     # No additional callbacks needed since requested_quantities.link(app) handles everything
#     # The requested_quantities callbacks already manage all the energy demand visualization logic
from profiles.recap.callbacks import requested_quantities

def link(app):
    """
    Link callbacks for the Energy demand-only overview visualization.
    Uses the requested_quantities callbacks since it's energy demand data.
    """
    requested_quantities.link(app)