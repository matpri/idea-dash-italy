...
reports: 
  TabName1: "path/to/markdown/report1.md"
  TabName2: "path/to/markdown/report2.md"

frames:
  - ProfileName: Visualization
  - ProfileName2: AnotherVisualization
...
- **frames**: Optional section to define frames for the narrative profile, which can be used to preload multiple frames
...
- If you want to include visualizations in the Markdown report, you will have to add these to the assets folder and reference them in the Markdown file.
